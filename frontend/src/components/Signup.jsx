...
function MainHeader() {
    return(
        ...
        <h4 className="text-sm text-slate-400 ">Enter your information to create an account</h4>
        </div>
    )
}
    ...
    return(
        <div >
            <form method="post" className="p-3">
                <div className="text-sm m-2">First Name</div>
                <input type="text" className="p-1 text-sm border w-full rounded-md focus:outline-none" placeholder="praneeth" required onChange={(e)=>{
                    setFirstName(e.target.value)
                }} />
                <div className="text-sm m-2">Last Name</div>
                <input type="text" className="p-1 text-sm border w-full rounded-lg focus:outline-none" placeholder="gupta" required onChange={(e)=>{
